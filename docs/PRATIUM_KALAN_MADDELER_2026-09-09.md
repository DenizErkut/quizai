...
6. **Rol bazlı deneyimler:** öğrenci, öğretmen, veli ve kurum ekranlarında açıklanabilir karar katmanları. Öğrenci dashboard öğrenme özeti v1 tamamlandı; öğretmen/veli/kurum alt ekranları sırada.
