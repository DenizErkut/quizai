...
export const SUBJECT_MAP_BY_GRADE: Record<string, Record<string, string[]>> = {
  ...
  '4': {
    ...
    'Sosyal Bilgiler': ['Aile ve toplum', 'Yakın çevremiz', 'Atatürk ve Kurtuluş Savaşı', 'Haklarım ve sorumluluklarım'],
  ...
  '6': {
    ...
    'Sosyal Bilgiler': ['Sosyal bilgi okuryazarlığı', 'Birey ve toplum', 'Bilim, teknoloji ve toplum', 'Gruplar, kurumlar, sosyal örgütler'],
  ...
  '7': {
    ...
    'Sosyal Bilgiler': ['Türk tarihinde yolculuk (Osmanlı öncesi Türk tarihi)', 'Üretim, dağıtım ve tüketim (ekonomi)', 'Küresel bağlantılar', 'Etkin vatandaşlık'],
