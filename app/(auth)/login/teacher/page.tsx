...
export default function TeacherLoginPage() {
  ...
  // da "şifremi unuttum" eklendi (öğrenci girişindeki (app/(auth)/login/
  // student/page.tsx) aynı desen: supabase.auth.resetPasswordForEmail,
  // ortak /auth/reset-password sayfasına yönlendiriyor — rol farketmiyor,
  // aynı auth kullanıcı tablosu).
