...
export default function LandingPage() {
  ...
  return <main className="landing-page">
    ...
    <section className="final-cta"><div className="landing-container"><img src="/mascot-prati.svg" alt="Prati maskotu"/><div><span>Bugün küçük bir adım at.</span><h2>Öğrenme yolculuğunu sana özel hale getir.</h2></div><Link href="/register" className="warm-button warm-button-light">Hemen başla →</Link></div></section>
    <SiteFooter />
  </main>
}
