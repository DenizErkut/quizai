...
const faqs = [
  ['Pratium’u ücretsiz deneyebilir miyim?','Pratium, Gümüş, Altın ve Platin planlarıyla ücretli bir platformdur. Gümüş, en uygun fiyatlı giriş planı olarak hemen başlamak isteyenler için idealdir.'],
  ...
  ['Dosyadan soru hazırlayabilir miyim?','Altın ve üzeri planlarda PDF, Word ve görsellerden içerikle uyumlu sorular oluşturabilirsin.'],
]
...
export default function LandingPage() {
  ...
  return <main className="landing-page">
    <header className="landing-nav"><div className="landing-container nav-inner">
      ...
      <div className="landing-actions"><Link href="/login" className="warm-link">Giriş yap</Link><Link href="/register" className="warm-button warm-button-small">Hemen başla</Link></div>
    </div></header>
    <section className="landing-hero"><div className="landing-container hero-grid">
      <div className="hero-copy"><div className="warm-badge">✦ Sana göre şekillenen öğrenme</div><h1>Ezberleme.<br/><em>Gerçekten öğren.</em></h1><p>Pratium güçlü ve gelişime açık konularını anlayıp sana özel bir çalışma yolu çıkarır. Daha az karmaşa, daha çok ilerleme hissi.</p><div className="hero-actions"><Link href="/register" className="warm-button">Hemen başla <span>→</span></Link><a href="#nasil-calisir" className="warm-button warm-button-quiet">Nasıl çalıştığını gör</a></div><div className="hero-proof"><div className="avatar-stack"><span>DE</span><span>AS</span><span>MK</span></div><p><strong>Her seviyeye uygun</strong><br/>MEB müfredatı ve 8 farklı soru tipi</p></div></div>
      <div className="hero-demo"><div className="demo-top"><span className="demo-subject">Matematik</span><span>3 / 8 soru</span></div><div className="demo-progress"><span/></div><div className="prati-note"><img src="/mascot-prati-face-v2.webp" alt=""/><span>Harika gidiyorsun! Bu soruyu birlikte düşünelim.</span></div><h2>Bir üçgenin iç açıları toplamı kaç derecedir?</h2><div className="demo-options"><button>A <span>90°</span></button><button className="selected">B <span>180°</span><b>✓</b></button><button>C <span>270°</span></button></div><div className="demo-footer"><span>🔥 7 günlük seri</span><span>Doğru cevap!</span></div></div>
    </div></section>
    ...
    <section className="final-cta"><div className="landing-container"><img src="/mascot-prati-v2.webp" alt="Prati maskotu"/><div><span>Bugün küçük bir adım at.</span><h2>Öğrenme yolculuğunu sana özel hale getir.</h2></div><Link href="/register" className="warm-button warm-button-light">Hemen başla →</Link></div></section>
    <SiteFooter />
  </main>
}
