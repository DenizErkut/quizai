...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    load()
  }, [pathname]) // pathname değişince yeniden yükle
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              <span style={{ display: 'none' }} className="lang-label">{activeLang.code}</span>
                  ...
                  {LANGS.map(l => (
                    <button key={l.code} onClick={() => saveLang(l.code)}
                      style={{
                        ...
                        border: 'none', background: profile.language === l.code ? 'var(--accent-bg)' : 'transparent',
                        color: profile.language === l.code ? 'var(--accent)' : 'var(--text)',
                        fontSize: '13px', cursor: 'pointer', fontWeight: profile.language === l.code ? 600 : 400,
